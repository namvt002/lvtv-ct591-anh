...
export default function InvoiceToolbar({diem, baithi, userName}) {
    ...
    return (
        <>
            <Stack mb={5} direction="row" justifyContent="flex-end" spacing={1.5}>
                ...
                <PDFDownloadLink
                    document={<InvoicePDF diem={diem} baithi={baithi} userName={userName} />}
                    fileName={`bky-${baithi?.baikiemtra?.bkt_id}`}
                ...
                <Box sx={{height: '100%', display: 'flex', flexDirection: 'column'}}>
                    ...
                    <Box sx={{flexGrow: 1, height: '100%', overflow: 'hidden'}}>
                        <PDFViewer width="100%" height="100%" style={{border: 'none'}}>
                            <InvoicePDF diem={diem} baithi={baithi} userName={userName}/>
                        </PDFViewer>
                    </Box>
                </Box>
            </DialogAnimate>
