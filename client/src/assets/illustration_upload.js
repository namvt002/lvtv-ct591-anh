        ...
        <Box {...other}>
            <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 480 360">
                ...
                <g fill="none" fillRule="evenodd" stroke="none" strokeWidth="1">
                    ...
                    />
                    <ellipse cx="390.052" cy="264.383" fill={PRIMARY_MAIN} fillRule="nonzero" opacity="0.1" rx="5.044"
                             ry="1"/>
                    <path
                        fill={PRIMARY_MAIN}
                        fillRule="nonzero"
                    ...
                    />
                    <ellipse cx="346.97" cy="270.022" fill={PRIMARY_MAIN} fillRule="nonzero" opacity="0.1" rx="6.09"
                             ry="1.028"/>
                    <rect
                        width="51.026"
                        height="91.312"
                    ...
                    <path
                        ...
                        opacity="0.32"
                    />
                    <ellipse cx="119.593" cy="258.664" fill={PRIMARY_MAIN} fillRule="nonzero" opacity="0.1" rx="4.846"
                             ry="1"/>
                    <ellipse cx="101.03" cy="260.545" fill={PRIMARY_MAIN} fillRule="nonzero" opacity="0.1" rx="4.846"
                             ry="1"/>
                    <ellipse cx="108.459" cy="265.905" fill={PRIMARY_MAIN} fillRule="nonzero" opacity="0.1" rx="3.444"
                             ry="1"/>
                    <ellipse cx="89.193" cy="265.433" fill={PRIMARY_MAIN} fillRule="nonzero" opacity="0.1" rx="3.444"
                             ry="1"/>
                    <path
                        fill={PRIMARY_MAIN}
                        fillRule="nonzero"
                    ...
                    />
                    <path stroke={PRIMARY_DARKER} strokeLinecap="round" strokeWidth="0.5"
